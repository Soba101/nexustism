...
print(similarities)
# tensor([[1.0000, 0.9787, 0.0691],
#         [0.9787, 1.0000, 0.0845],
#         [0.0691, 0.0845, 1.0000]])
```
...
* Size: 1,270 training samples
* Columns: <code>sentence_0</code>, <code>sentence_1</code>, and <code>label</code>
* Approximate statistics based on the first 1000 samples:
  |         | sentence_0                                                                           | sentence_1                                                                           | label                                                         |
  |:--------|:-------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------|:--------------------------------------------------------------|
  | type    | string                                                                               | string                                                                               | float                                                         |
  | details | <ul><li>min: 34 tokens</li><li>mean: 155.82 tokens</li><li>max: 512 tokens</li></ul> | <ul><li>min: 33 tokens</li><li>mean: 154.92 tokens</li><li>max: 512 tokens</li></ul> | <ul><li>min: 1.0</li><li>mean: 1.0</li><li>max: 1.0</li></ul> |
* Samples:
  | sentence_0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | sentence_1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | label            |
  |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
  | <code>Dear Team Error occurred while processing the EDI transaction Interface GITP Subsidiary PIDSMY API Name inds-global-if-mgmt-papi Flow Direction Inbound Source System IBMMQ End System SAP File Name NA Storage Path No Attachment Error Source Mulesoft Transaction ID ID:363039393836373230303030303030303030303720202020 Error Summary 500 CONNECTIVITY Error Details ***********443/api/v1/sender-receiver-code-reference-data' failed: Remotely closed. Comments  Thanks and Regards, APAC Support, Panasonic (Context: [mulesoft/eai] [application/software \| job failure] Group: piscap l2 mulesoft/soa)</code>                                                             | <code>Dear Team Error occurred while processing the EDI transaction Interface Subsidiary No Subsidiary API Name pana-pagitp-mgmt-eapi Flow Direction Inbound Source System PAGITP End System SAP S4Hana File Name No File Name Storage Path No Attachment Error Source Mulesoft Transaction ID 42565712-f87c-4800-acae-010dd0471e41 Error Summary 500 SOURCE_RESPONSE_SEND Error Details Client connection was closed Comments  Thanks and Regards, APAC Support, Panasonic (Context: [mulesoft/eai] [application/software \| integration] Group: piscap l2 mulesoft/soa)</code> | <code>1.0</code> |
  | <code>PSV got the wrong font when trying print out from pdf! (Context: [sap \| sd - sales and distribution] [application/software \| user interface (ui)] Group: capg l2 sd brs)</code>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | <code>T code : ZMSD_POSTINGCHK - Posting Status Check by DO (Context: [sap \| sd - sales and distribution] [application/software \| configuration] Group: capg l2 sd brs)</code>                                                                                                                                                                                                                                                                                                                                                                                                 | <code>1.0</code> |
  | <code>Dear Team Error occurred while processing the EDI transaction Interface Subsidiary No Subsidiary API Name pana-pagitp-mgmt-eapi Flow Direction Inbound Source System PAGITP End System SAP S4Hana File Name No File Name Storage Path No Attachment Error Source Mulesoft Transaction ID 3e127f40-18cc-11f0-84e4-8ac369b452e1 Error Summary 500 CONNECTIVITY Error Details Could not establish SFTP connection with host: '10.86.48.62' at port: '22' - Session.connect: java.net.SocketTimeoutException: Read timed out Comments  Thanks and Regards, APAC Support, Panasonic (Context: [mulesoft/eai] [application/software \| integration] Group: piscap l2 mulesoft/soa)</code> | <code>Dear Team Error occurred while processing the EDI transaction Interface Subsidiary No Subsidiary API Name pana-pagitp-mgmt-eapi Flow Direction Inbound Source System PAGITP End System SAP S4Hana File Name No File Name Storage Path No Attachment Error Source Mulesoft Transaction ID 5d4e5339-4ed5-46f0-a2e3-92832a4479e4 Error Summary 500 SOURCE_RESPONSE_SEND Error Details Client connection was closed Comments  Thanks and Regards, APAC Support, Panasonic (Context: [mulesoft/eai] [application/software \| job failure] Group: piscap l2 mulesoft/soa)</code> | <code>1.0</code> |
