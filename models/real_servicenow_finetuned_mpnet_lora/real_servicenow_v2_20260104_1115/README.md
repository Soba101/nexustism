...
print(similarities)
# tensor([[1.0000, 0.9992, 0.9991],
#         [0.9992, 1.0000, 0.9989],
#         [0.9991, 0.9989, 1.0000]])
```
...
* Approximate statistics based on the first 1000 samples:
  ...
  | details | <ul><li>min: 16 tokens</li><li>mean: 132.51 tokens</li><li>max: 256 tokens</li></ul> | <ul><li>min: 14 tokens</li><li>mean: 130.89 tokens</li><li>max: 256 tokens</li></ul> | <ul><li>min: 0.0</li><li>mean: 0.43</li><li>max: 1.0</li></ul> |
* Samples:
  | sentence_0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | sentence_1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | label            |
  |:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
  | <code>INC0044952 Dear Team<br><br>Error occurred while processing the EDI transaction<br><br>Interface       ar-statement<br>Subsidiary      GITP<br>API Name        inds-global-if-mgmt-papi<br>Flow Direction  outbound<br>Source System   GITP<br>End System      SAP<br>File Name       No File Name<br>Storage Path    No Attachment<br>Error Source    SAP<br>Transaction ID  f6504e40-b8ee-11ef-a324-5692c9f84f9d<br>Error Summary   500 INTERNAL_SERVER<br>Error Details   UNKNOWN: Cannot process event as "inds-gitp-papi-ar-statements-scheduler-impl-flow" is stopped<br>Comments<br><br>Note: This is an automated mail, please do not reply.<br><br>Thanks and Regards,<br><br>APAC Support, Panasonic this error is caused by manual API restart, verified it is running now</code>                                                                                                                         | <code>INC0037423 We have an issue with Quitation/ RFQ with number 6000018646. in this quotation we have 4 material,   <br>but when our user approved there are only 3 material on PIR. Material ACXB09-10430 not success to approved, but the status already approved.   <br>please help to check this issue. As per the analysis shared user was able to approve all 4 materials in PIR , Issue is been addressed , hence closing the incident.</code>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>0.0</code> |
  | <code>INC0050501 Dear Team<br><br>Error occurred while processing the EDI transaction<br><br>Interface       submit-documents<br>Subsidiary      PM<br>API Name        pana-my-einvoice-mgmt-papi<br>Flow Direction  outbound<br>Source System   PM<br>End System      IRBM<br>File Name       No File Name<br>Storage Path    No Attachment<br>Error Source    pana-irbm-einvoice-sapi<br>Transaction ID  9f57ce67-5765-4345-8ca4-3f099efca4f6<br>Error Summary   400 BAD_REQUEST<br>Error Details   The authenticated TIN and documents TIN is not matching<br>Comments<br><br>Note: This is an automated mail, please do not reply.<br><br>Thanks and Regards,<br><br>APAC Support, Panasonic User error</code>                                                                                                                                                                                                         | <code>INC0050817 Please help to re-check and correct budget utilized, pending approval amount of eIAF budget in the URL: http://www.eworkplace.intra.panasonic.com.sg/sites/PV/eIAF/Lists/SalesBudgetMaintenance.  <br>I attached 2 imagines: one is wrong amount (currently) and one is correct amount (I think that). Dear @Dao Thi Phuong san,  <br>Good evening!!!  <br>  <br>As discussed in team, the reported budget values are available as expected in the eIAF application.  <br>Attached latest budgetmaster and sales2item detail reports for your references. Hence confirmed with your end, we are proceeding to close this ticket.  <br>  <br>2024 Warranty cost:  <br>  <br>Documents are in Approved status  <br>•	eIAF22693  <br>•	eIAF23651  <br>•	eIAF23769   <br>  <br>Travelling expenses - Domestic  & Post and Tel - Mobile phone  <br>  <br>•	eIAF20106.  <br>  <br>Furnitures - Equipments and Stationery  <br>  <br>Amounts are captured as expected in the budget master.  <br>•	eIAF20102  <br>•	eIAF22301  <br>•	eIAF24253  <br>  <br>Electricity - Gas - Water supply expenses  <br>  <br>Amounts are captured as expected ...</code> | <code>1.0</code> |
  | <code>INC0057740 Hi team,  <br>  <br>The filters for 'View & Submit Time Sheet' page are Not Working, although this has always been working - don't know whether this is part of any changes you are making for another ticket?  <br>  <br>Partial is used by business often to test different things at different times. This means it requires functions like these to work. Can we kindly request to have this fixed/ reverted to when it was working please?  <br>  <br>Thank you. issue:  <br>Filters not working on time sheet page  <br>  <br>Category:  <br>CRM Issue  <br>  <br>Failure point:  <br>Filters show incorrect results  <br>  <br>Root cause:  <br>Code changes for another ticket affected filter functionality  <br>  <br>Fix:  <br>Reverted recent code changes in the sandbox environment  <br>  <br>Preventive Action:  <br>Tested by commenting code in shared sandbox before full fix  <br>  <br>Outage:  <br>NA</code> | <code>INC0028187 Below are list SO number that can’t open in Sales Force, so Cancelling process can’t be done by us  <br>Kindly raise to related members to check why it happen? ? Sorry we think this is fix internal Issue (Not human Mistake) , Please check for this deeply   <br>Note : We attached excel attachment for detail too, (Please see the excel attachment for this) Hi @[Very Hardian],   <br>  <br>We have provided the Work around solution by adding manual sharing of the records and raised problem ticket PRB0040110 to attach similar issue and implement a permanent fix.  <br>  <br>  <br>Regards,  <br>Ansuman</code>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | <code>0.0</code> |
