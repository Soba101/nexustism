...
print(similarities)
# tensor([[1.0000, 0.9989, 0.9988],
#         [0.9989, 1.0000, 0.9982],
#         [0.9988, 0.9982, 1.0000]])
```
...
* Approximate statistics based on the first 1000 samples:
  ...
  | details | <ul><li>min: 17 tokens</li><li>mean: 134.54 tokens</li><li>max: 256 tokens</li></ul> | <ul><li>min: 16 tokens</li><li>mean: 137.72 tokens</li><li>max: 256 tokens</li></ul> | <ul><li>min: 0.0</li><li>mean: 0.5</li><li>max: 1.0</li></ul> |
* Samples:
  | sentence_0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | sentence_1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | label            |
  |:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|
  | <code>INC0015700 PSTH PO : 7931014716 release indicator become 'Block' after automatic create FPL inbound We get confirmation from user for closer of this ticket.</code>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | <code>INC0018671 File ID         :=WEBM779X  <br>Transmission ID :=20240520143300  <br>Message Type    :=79  <br>Trading Partner :=WEBM779X  <br>#--------------------------------------------#  <br>   <br>Glovia program failed to start, Exiting uis.sh. manage the failed job in SOA and email Glovia Sales IT to verify in G2 and if need to reprocess  <br>G2 error  <br>clear the status file and email Glovia IT to verify if processed in G2</code>                                                                                                                                                                                     | <code>1.0</code> |
  | <code>INC0051605 Creation date 20/1/25 is before expiry date 22/1/25. resolved by change</code>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | <code>INC0067215 Hi Team ,   <br>  <br>Please see product consumptions below all the products have been returned but the quantity consumed still shows a quantity in field QuantityConsumed on ProductConsumed  <br>  <br>PC-11219  <br>https://hussmann-nz.lightning.force.com/lightning/r/ProductConsumed/0GvfR0000009mgXSAQ/view  <br>The van has received the stock back   <br>  <br>PC-11235  <br>https://hussmann-nz.lightning.force.com/lightning/r/ProductConsumed/0GvfR0000009w81SAA/view  <br>same with PC-11236   <br>  <br>Thanks   <br>Elaine</code>                                                                                     | <code>0.0</code> |
  | <code>INC0069110 Dear Team<br><br>Error occurred while processing the EDI transaction<br><br>Interface<br>Subsidiary      No Subsidiary<br>API Name        pana-pagitp-mgmt-eapi<br>Flow Direction  Inbound<br>Source System   PAGITP<br>End System      SAP S4Hana<br>File Name       No File Name<br>Storage Path    No Attachment<br>Error Source    Mulesoft<br>Transaction ID  1f0c3b76-be9a-466d-b891-6adecc6222b6<br>Error Summary   500 SOURCE_RESPONSE_SEND<br>Error Details   Client connection was closed<br>Comments<br><br>Note: This is an automated mail, please do not reply.<br><br>Thanks and Regards,<br><br>APAC Support, Panasonic YEMM_IPL_INVOICE01 iDoc posted successfully to SAP</code> | <code>INC0015046 user : Geri   <br>SO :  110039581   <br>Total amount still include 1st line though already mark rejection .   <br>pls refer to attached. Hi Geri Koh  <br>As the team is new, the explanation given is bit technical. sorry about it  <br>Basically,  certain 'Reason for Rejection ' only are configured not to consider the Sales order amount.  <br>  <br>Are you able to use the 'Customer Cancellation' for such rejection reason?  <br>In the system  the reason  'Copied & Rejected' is not configured for this SO amount re-dertermination  <br>  <br>Pls let us know your feedback  <br>  <br>  <br>Regards  <br>Bala</code> | <code>1.0</code> |
