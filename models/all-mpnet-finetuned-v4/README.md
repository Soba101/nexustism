...
- source_sentence: 'Request: Adjust Server/User access configuration in Mulesoft/EAI.
  ...
  sentences:
  - 'Integration failure: SAP → SD - Sales and Distribution; data mismatch. I encountered
    an issue where Integration failure: SAP → SD - Sales and Distribution; data mismatch.
  ...
  - 'Integration failure: SAP → WM - Warehouse Management; job stuck in queue. I noticed
    that Integration failure: SAP → WM - Warehouse Management; job stuck in queue,
...
- source_sentence: 'Request: Adjust Database/Report configuration in SAP. There appears
  ...
  - 'SAP Report: Database — user reports IDOC not generated. I noticed that SAP Report:
    Database — user reports IDOC not generated, and it seems to be causing unexpected
  ...
  - 'Integration failure: CRM (D365, SalesForce, Genesis, PCube, HussMann Services)
    → SD - Sales and Distribution; IDOC not generated. I''ve been facing difficulties
    because Integration failure: CRM (D365, SalesForce, Genesis, PCube, HussMann Services)
    → SD - Sales and Distribution; IDOC not generated. Requesting help to look into
...
- source_sentence: 'Adjust Adjust Integration/Job failure configuration in SAP. on
  ...
  - 'Integration failure: SAP → BC - Basis; posting failed. While working on the system,
    I observed that Integration failure: SAP → BC - Basis; posting failed. I''m raising
...
- source_sentence: 'Request: Adjust Server/Job failure configuration in eWorkplace
  ...
  - 'eWorkplace (eWorkplace SharePoint & eWorkplace ServiceNow) Report: Application/Software
    — user reports data mismatch. There appears to be a problem related to eWorkplace
    (eWorkplace SharePoint & eWorkplace ServiceNow) Report: Application/Software —
